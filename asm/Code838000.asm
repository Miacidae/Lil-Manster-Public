...
aUnknown83801F ; 83/801F
	...
	.addr rsPreps83B9C9 ; rsUnknown838513
	.word $0000
...
aUnknown83848B ; 83/848B
	...
	.addr rsPreps8385CC ; rsUnknown8385EE
	.word $001F
	...
	.addr rsUnknown838AC1 ; minimap init 1
	.word $0010

	.addr rsUnknown838AD1 ; 10
	.word $0011
	...
	.addr rsUnknown838E58 ; 1F
	.word $0000

	.addr rsUnknown838A39 ; 20
	.word $0008
...
; new
	...
	.addr rsGlobalRangeCancelCursorPlacementHook
	.word $001F
...
;	jsl rlDisplayMinimap	; show minimap
	...
	jsl rlGlobalRangeButtonInputCheck
...
rsPreps8385CC ; on prep map draws units move/attack range when selected
	...
	jsr rsUnknown83894C ; update maps and cancel range
	jsr rsUnknown838669 ; center cursor on last selected unit 
	jsl $8A9013
	jmp rsUnknown838529
	...
	jmp rsMapEnableFastCursor

	_Out
	rts 


rsGlobalRangeCancelCursorPlacementHook ; 838633

	jsl rlGlobalRangeCancelCursorPlacement
	rts 
...
rsMapDrawUnitsAttackRange ; 83/86A4
...
rsMapOpenUnitInventory ; 83/873F
...
;	asl a
	...
	jml HookCh19HostageC
	_HookCh19HostageCReturn

	tax
	lda $86DA4D,x ;CharacterNames.aCharacterNamePointers,x
	sta lR18
	ply
	plx
	plp
...
rlGetWeaponRankTextPointer ; 83/936D
	...
	asl a
	tax
	lda #>`$8393AC ; WeaponRankText2
	sta lR18+1
	lda $8393AC,x  ;WeaponRankText2.aRankTextPointers,x
	sta lR18
	plp
	rtl

	WeaponRankText2 .block ; 83/93AC
...
rsDropRescuee ; 83/9EA3
	...
	stz aTemporaryActionStruct.Rescue,b
...
rlGetEffectiveConstitution ; 83/A855
	...
	cmp #IronBallistician
	beq _CanDismount

	cmp #VeninBallistician
	beq _CanDismount
...
rsUnknownMenuDrawLabels ; 83/B4C5
	...
	.byte $60, $82, $6B, $82, $75, $00, $00
	.byte $82, $67, $82, $6F, $00, $00
	.byte $83, $4A, $00, $00
	.byte $82, $DC, $83, $4A, $00, $00
	.byte $82, $ED, $82, $B4, $00, $00
	.byte $82, $CD, $82, $E2, $82, $B3, $00, $00
	.byte $82, $A4, $82, $F1, $00, $00
	.byte $82, $DC, $82, $E0, $82, $E8, $00, $00
	.byte $91, $E0, $82, $A9, $82, $AD, $00, $00
	.byte $82, $A2, $82, $C7, $82, $A4, $00, $00
	.byte $81, $5E, $00, $00
